...
#                 print(c)
                ...
                auc = calc_AUC(test_Y, pred_prob)
                if best_c == 0 or auc > best_auc:
                    best_auc = auc
                    best_c = c
                    
        print('\nBest value of C:', best_c, 'Best AUC:', best_auc)
...
def RBF_kernel(df, K, M, C, gamma):
#     gamma = [2**i for i in range(-5, 4)]
